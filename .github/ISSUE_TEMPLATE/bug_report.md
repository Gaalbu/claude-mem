...
- [ ] I searched [existing issues](https://github.com/gaalbu/claude-mem/issues) and confirmed this is not a duplicate
...
**Plugin Paths:**
- **macOS/Linux**: `~/.claude/plugins/marketplaces/gaalbu`
- **Windows**: `%USERPROFILE%\.claude\plugins\marketplaces\gaalbu`
