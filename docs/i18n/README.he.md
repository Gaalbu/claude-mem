...
- **תיעוד**: [docs/](docs/)
- **בעיות**: [GitHub Issues](https://github.com/gaalbu/claude-mem/issues)
- **מאגר**: [github.com/gaalbu/claude-mem](https://github.com/gaalbu/claude-mem)
- **חשבון X רשמי**: [@Claude_Memory](https://x.com/Claude_Memory)
- **דיסקורד רשמי**: [הצטרף לדיסקורד](https://discord.com/invite/J4wttp9vDu)
- **מחבר**: Alex Newman ([@gaalbu](https://github.com/gaalbu))
