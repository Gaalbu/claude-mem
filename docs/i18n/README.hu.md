...
- **Hibák**: [GitHub Issues](https://github.com/gaalbu/claude-mem/issues)
- **Tároló**: [github.com/gaalbu/claude-mem](https://github.com/gaalbu/claude-mem)
...
- **Szerző**: Alex Newman ([@gaalbu](https://github.com/gaalbu))
