...
- **التوثيق**: [docs/](docs/)
- **المشكلات**: [GitHub Issues](https://github.com/gaalbu/claude-mem/issues)
- **المستودع**: [github.com/gaalbu/claude-mem](https://github.com/gaalbu/claude-mem)
- **حساب X الرسمي**: [@Claude_Memory](https://x.com/Claude_Memory)
- **Discord الرسمي**: [انضم إلى Discord](https://discord.com/invite/J4wttp9vDu)
- **المؤلف**: Alex Newman ([@gaalbu](https://github.com/gaalbu))
