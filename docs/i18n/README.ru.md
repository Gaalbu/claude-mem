...
- **Проблемы**: [GitHub Issues](https://github.com/gaalbu/claude-mem/issues)
- **Репозиторий**: [github.com/gaalbu/claude-mem](https://github.com/gaalbu/claude-mem)
...
- **Автор**: Alex Newman ([@gaalbu](https://github.com/gaalbu))
