...
1. Clear install cache:
   ```bash
   rm ~/.claude/plugins/marketplaces/gaalbu/.install-version
   ```
...
3. Check version marker:
   ```bash
   cat ~/.claude/plugins/marketplaces/gaalbu/.install-version
   cat ~/.claude/plugins/marketplaces/gaalbu/package.json | grep version
   ```
...
3. Check package.json exists:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/gaalbu/package.json
   ```
...
3. Verify installation:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/gaalbu/
   ```
...
2. **Create issue**: [GitHub Issues](https://github.com/gaalbu/claude-mem/issues)
